...
public class LoginManager : MonoBehaviour
{
        ...
        else
        {
            ...
            else
            {
                ...
                if (FirebaseManager.Instance.user != null)
                {
                    ...
                    Task ProfileTask = FirebaseManager.Instance.user.UpdateUserProfileAsync(profile);
                    //Wait until the task completes
    ...
    private IEnumerator UpdateUsernameDatabase(string _username)
    {
        ...
        Task DBTask = FirebaseManager.Instance.DBreference.Child("users").Child(FirebaseManager.Instance.user.UserId).Child("username").SetValueAsync(_username);
    ...
    private IEnumerator UpdateUserDataInt(string _fieldName, int _value)
    {
        //Set the currently logged in user xp
        Task DBTask = FirebaseManager.Instance.DBreference.Child("users").Child(FirebaseManager.Instance.user.UserId).Child(_fieldName).SetValueAsync(_value);
    ...
    private IEnumerator UpdateUserDataString(string _fieldName, string _value)
    {
        //Set the currently logged in user xp
        Task DBTask = FirebaseManager.Instance.DBreference.Child("users").Child(FirebaseManager.Instance.user.UserId).Child(_fieldName).SetValueAsync(_value);
